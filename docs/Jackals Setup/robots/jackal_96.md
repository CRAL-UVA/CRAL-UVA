...
| **Autonomy stack repo** | [github.com/CRAL-UVA/CRALAutonomyStack/tree/main/jackal96](https://github.com/CRAL-UVA/CRALAutonomyStack/tree/main/jackal96) | (the code is not up-to-date yet)
